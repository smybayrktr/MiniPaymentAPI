...
public class YapiKrediServiceTests
{
    ...
    public YapiKrediServiceTests()
    {
        ...
        _yapiKrediService =
            new YapiKrediService(_transactionRepositoryMock.Object, _transactionDetailRepositoryMock.Object);
    }
    ...
    public async Task CancelAsync_ShouldUpdateTransactionAndAddTransactionDetail()
    {
        ...
        // Act
        var result = await _yapiKrediService.CancelAsync(transaction);
    ...
    public async Task RefundAsync_ShouldUpdateTransactionAndAddTransactionDetail()
    {
        ...
        // Act
        var result = await _yapiKrediService.RefundAsync(transaction);
    ...
    public async Task CancelAsync_ShouldThrowBusinessLogicException_WhenTransactionDateIsDifferent()
    {
        ...
        // Act & Assert
        var exception =
            await Assert.ThrowsAsync<BusinessLogicException>(() => _yapiKrediService.CancelAsync(transaction));
    ...
    public async Task RefundAsync_ShouldThrowBusinessLogicException_WhenRefundIsWithinOneDay()
    {
        ...
        // Act & Assert
        var exception =
            await Assert.ThrowsAsync<BusinessLogicException>(() => _yapiKrediService.RefundAsync(transaction));
