...
1. **Payment API Routes**
    ...
    - **Example:**
        - `POST /api/payment/pay` → **Payment API**
...
1. **Clone the Repository:**
    ```bash
    git clone https://github.com/smybayrktr/mini-payment-api.git
    cd mini-payment-api
    ```
...
2. **Access APIs:**
    ...
    - **API Gateway:** `https://localhost:5000/api`
